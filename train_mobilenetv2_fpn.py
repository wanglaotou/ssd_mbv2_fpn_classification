...
parser.add_argument('--dataset_root', default='/media/mario/新加卷/DataSets',
                    help='Dataset root directory path')
...
# parser.add_argument('--resume', default='weights_zhongdong/ssd_mobilenetv2_fpn_20200211/mobilenetv2_final.pth', type=str,
#                     help='Checkpoint state_dict file to resume training from')     
...
parser.add_argument('--save_folder', default='weights_zhongdong/',
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        # if iteration != 0 and iteration % 2000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights_zhongdong/ssd_mobilenetv2_fpn_20200305_addmiss/mobilenetv2_' +
                       repr(iteration) + '.pth')
    torch.save(ssd_net.state_dict(), 'weights_zhongdong/ssd_mobilenetv2_fpn_20200305_addmiss/mobilenetv2_final' + '.pth')
